...
<!--
	FIX: this page previously was a placeholder stub ("this is Rejected leave
	section") with no real data or query logic at all.
-->
	...
	<div class="main-content">
		...
		<div class="page-header">
			<div>
				...
				<p>All leave requests that have been Rejected</p>
			</div>
		</div>
		...
		try {
			...
			requests = dao.search(keyword, "Rejected", offset, pageSize);
			totalRecords = dao.countSearch(keyword, "Rejected");
		} catch (Exception e) {
			e.printStackTrace();
		}
		...
		<form class="filter-bar" method="get" action="<%=request.getContextPath()%>/admin/rejectedLeaves.jsp">
			...
			<table>
				...
				<tbody>
					...
					<tr>
						...
						<td><span class="rejected"><%=lr.getStatus()%></span></td>
					</tr>
					<%
						}
					} else {
					%>
					<tr>
						<td colspan="10" style="text-align:center; color:#64748b;">No Rejected leave requests found.</td>
					</tr>
					<%
					}
					%>
